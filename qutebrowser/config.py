...
userscripts_pattern = (Path.home() / ".config/qutebrowser/userscripts").as_uri() + "/*"
...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, userscripts_pattern)

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, userscripts_pattern)
